...
%La integración final consistió en el acoplamiento del sub-ensamble de flexión sobre el eje de abducción. Se verificó la perpendicularidad de los ejes mediante escuadras magnéticas antes del apriete final de la tornillería.
%Se realizaron ajustes en sitio (barrenado manual) para la colocación de los sensores de límite de carrera, asegurando que se activen antes de que el mecanismo alcance sus topes mecánicos físicos.
