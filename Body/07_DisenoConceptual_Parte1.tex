\section{Diseño del sistema}\label{Diseño del sistema}
...
\begin{table}[h!]
	...
	\scalebox{0.8}{\begin{tabular}{|m{9.5cm}|m{9.5cm}|}
		\hline
...
\begin{table}[h!]
	...
	\scalebox{0.9}{\begin{tabular}{|m{6cm}|m{6cm}|m{4.5cm}|}
		\hline
...
\begin{figure}[h!]
	\centering
	\includegraphics [trim = 0 0cm 0 0, clip, angle=90, width=0.6\textwidth]{figure/P01_fbs.png}
...
\begin{figure}[h!]
	\centering
	\includegraphics [trim = 0 0cm 0 0, clip, angle = 90, width=0.4\textwidth]{figure/P02.jpg}
...
\begin{figure}[h!]
	\centering
	\includegraphics [angle = 90, trim = 0 0cm 0 0, clip, width=0.7\textwidth]{figure/P03.png}
...
En el diagrama de la Figura \ref{fig:Arquitectura_Fisica} se muestra la interacción entre los sistemas y módulos que realizarán las funciones generales de la ortesis.
\begin{figure}[h!]
	\centering
	\includegraphics [trim = 0 0cm 0 0, clip, width=1\textwidth]{figure/P04.png}
