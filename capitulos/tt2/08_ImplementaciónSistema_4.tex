\clearpage
\section{Sistema de Comunicación HMI (S6)}

La implementación del sistema de interfaz Humano-Máquina se realizó apegándose a la arquitectura definida en la fase de diseño, integrando un módulo de visualización física parea entradas y salidas, y un módulo lógico de gestión de datos. La interfaz actúa como el puente intercambiando información con sistema de control. A continuación se describe la implementación de los módulos que conforman a este sistema.

\subsection{Implementación del módulo de E/S (M10)}
...
La navegación se estructuró mediante un \texttt{QStackedWidget} que administra las pantallas de: \textit{Inicio, Calibración, Selección de Terapia y Ejecución}.

%\begin{figure}[h!]
%	\centering
%	\includegraphics[width=0.45\textwidth]{figure/pantallas_interfaz/App Ver1.0/Inicio.png}
%	\hfill
%	\includegraphics[width=0.45\textwidth]{figure/pantallas_interfaz/App Ver1.0/Terapia.png}
%	\caption{Interfaz gráfica implementada: Pantalla de Bienvenida (izq) y Monitor de Terapia (der).}
%	\label{fig:gui_screens}
%\end{figure}

\subsubsection{Verificación del módulo de visualización}
...
\\
\textbf{Procedimiento:} Se ejecutó el script \texttt{app\_fisio\_final.py} en el entorno real. Se realizaron pulsaciones rápidas en los botones de navegación y se observó el consumo de CPU.
\\
...
\begin{verbatim}
	...
	├── app_fisio_final.py   (Código fuente principal)
	├── styles.py            (Hoja de estilos y constantes visuales)
	└── assets/              (Iconos, logotipos y diagramas de ayuda)
\end{verbatim}
...
\subsubsection{Verificación del módulo de interacción y datos}
