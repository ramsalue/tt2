\subsection{ S5. Sistema de movimiento}\label{S5_Sistema de movimiento}
...
\subsubsection{M8. Módulo de actuador lineal} 
...
\begin{table}[h!]
	...
	\scalebox{1}{\begin{tabular}{clcc|c|c|}
		\hline
...
\begin{figure}[h!]
	\centering
	{\includegraphics[width=0.55\textwidth]{figure/S7_control/HSS57_Med.jpg}}
...
\begin{figure}[h!]
	\centering
	{\includegraphics[width=0.35\textwidth]{figure/S7_control/57HSE.png}}
...
\end{figure}
\clearpage
\subsubsection{M9. Módulo de actuador rotativo}
...
\begin{figure}[h!]
	\centering
	{\includegraphics[width=0.45\textwidth]{figure/S7_control/HSS86_Med.jpg}}
	\caption[Medidas de driver HSS86 (Cotas en mm).]{Medidas de driver HSS86 (Cotas en mm).}
	\label{fig:HSS86_med}
\end{figure}

De igual manera, a partir de la tabla de especificaciones del driver, podemos elegir el modelo específico del motor para una óptima respuesta en la combinación entre driver y motor a pasos. Por lo que el modelo de motor a utilizar será el 86HSE, como se muestra en la Fig. \ref{fig:86HSE}.
